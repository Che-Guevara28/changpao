...
def ChoseEmail(name,text,content):
    if name == "王佳辉":
        ...
        email(text,content,'1845489481@qq.com')
    elif name == "马林":
        email(text,content,'1403921334@qq.com')
    elif name == "马爽":
        email(text,content,'2735925863@qq.com')
    elif name == "刘雨洋":
        email(text,content,'461099544@qq.com')
    elif name == "黄炜栊":
        email(text,content,'2313138003@qq.com')
    elif name == "朱翔堃":
        email(text,content,'1971808099@qq.com')
    else:
...
if __name__ == '__main__':
    ...
    name_list = ["王佳辉","王岩","王奕翔","平玮","郑忠宇","禹宇帅","张宇霆","孙嘉文","吴文轩","王纪元","马林","马爽","刘雨洋","黄炜栊","朱翔堃"]
    print('*' * 50)
    s = "无效CODE：\n"
